...
Based on [GSD 1.39.1](https://github.com/gsd-build/get-shit-done) by TACHES (Lex Christopherson).
...
---
*Last updated: 2026-05-01 — synced upstream GSD 1.39.1 hotfix (plugin v2.39.1); local patches preserved in core.cjs + gsd-tools.cjs.*
