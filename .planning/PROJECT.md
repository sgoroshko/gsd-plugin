...
Based on [GSD 1.41.0](https://github.com/gsd-build/get-shit-done) by TACHES (Lex Christopherson).
...
---
*Last updated: 2026-05-07 — synced upstream GSD 1.41.0 (plugin v2.41.0); MCP stdio framing fix + ndjson regression test landed in 2.40.2.*
