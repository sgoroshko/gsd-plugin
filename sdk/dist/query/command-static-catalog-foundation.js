...
export const STATE_SUPPORT_STATIC_CATALOG = [
...
export const MUTATION_SURFACES_STATIC_CATALOG = [
...
export const VERIFY_DECISION_STATIC_CATALOG = [
...
export const DECISION_ROUTING_STATIC_CATALOG = [
